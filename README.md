...
**v2.0** — 进入已保存 WiFi 区域自动开启手机 WiFi；WiFi 断开或离开范围后自动关闭。\
**v20 新增** ：KSU "执行"按钮立即重启守护进程，使配置生效。\
...
### 纯ai做的,有什么bug可以提交issue,我不一定会修

小bug如果你会修的话,直接提交分支也行

只在我的手机上测试过,其他手机用不了也别问我,我没有其他手机

REDMI Turbo 5 MAX 澎湃3.0 SUKISU
